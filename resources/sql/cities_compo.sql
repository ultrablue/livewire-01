...
--
-- Host: mysql
-- Generation Time: Sep 10, 2021 at 02:46 AM
...
--
-- Table structure for table `cities_compo`
--

CREATE TABLE `cities_compo` (
  `name` varchar(150) NOT NULL COMMENT 'The name of the city.',
  `state` char(2) NOT NULL COMMENT 'The state code.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cities_compo`
--

INSERT INTO `cities_compo` (`name`, `state`) VALUES
('Aaronsburg', 'PA'),
('Abbeville', 'AL'),
('Abbeville', 'GA'),
('Abbeville', 'LA'),
...
--
-- Indexes for table `cities_compo`
--
ALTER TABLE `cities_compo`
  ADD PRIMARY KEY (`name`,`state`);
COMMIT;
